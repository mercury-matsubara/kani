...
<?php
	...
	echo '<td class = "two"><input type = "password" size = "31" name = "passCheck" id="passCheck" 
				onchange ="return inputcheck(\'passCheck\',20,3);" class = "txtmode2" ></td>';
	echo "</tr></table>";
	echo "<br>";
	echo "<div class = 'center'>";
